<template>
	<view style="padding: 30rpx;">
		<view style="background: #F6F7F9;border-radius: 32rpx;display: flex;padding: 6rpx;width: 290rpx;justify-content: space-between;">
			<view @click="changeType(1)" style="width: 144rpx;height: 68rpx;border-radius: 28rpx;font-weight: 400;font-size: 32rpx;text-align: center;line-height: 68rpx;"
			...
			<view @click="changeType(2)" style="width: 144rpx;height: 68rpx;border-radius: 28rpx;font-weight: 400;font-size: 32rpx;text-align: center;line-height: 68rpx;"
		...
		<view v-for="(item, index) in list" :key="index" style="box-shadow: 0rpx 6rpx 32rpx 2rpx rgba(0,0,0,0.08);padding: 30rpx;border-radius: 32rpx;margin-top: 35rpx;
			">
			...
			<view style="display: flex;justify-content: space-between;align-items: center;margin-top: 30rpx;">
				...
				<view @click="buy(item.id)" style="width: 136rpx;height: 64rpx;background: #2EBD85;border-radius: 32rpx;font-weight: 400;font-size: 28rpx;color: #FFFFFF;
	...
	export default {
		...
		methods: {
			getList() {
				...
				this.$request('get', 'api/index/getMAdList', {
					type: this.type
				}).then(res => {
					uni.hideLoading()
					if (res.code) {
