	...
	<view style="padding: 30rpx;">
		...
		<view v-for="(item, index) in list" :key="index" style="box-shadow: 0rpx 6rpx 32rpx 2rpx rgba(0,0,0,0.08);padding: 30rpx;border-radius: 32rpx;margin-top: 35rpx;
			...
			<view style="display: flex;margin-top: 20rpx;align-items: center;">
				...
				<view style="margin-left: 10rpx;font-weight: 500;font-size: 24rpx;color: #A9ABB6;">{{item.pay_time}}分钟
				</view>
			</view>
			...
			<view style="display: flex;justify-content: space-between;align-items: center;margin-top: 30rpx;">
				<view>
					<view style="display: flex;">
						...
						<view style="margin-left: 26rpx;font-weight: bold;font-size: 24rpx;">{{item.num.toFixed(2)}} Y币
						</view>
					</view>
