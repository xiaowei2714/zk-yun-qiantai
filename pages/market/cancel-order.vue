<template>
	<view>
		<u-navbar @leftClick="goBack"></u-navbar>
		<view style="padding: 30rpx;">
			<view style="font-weight: bold;font-size: 60rpx;margin-top: 70rpx;width: 100%;text-align: center;">
				{{ info.num  }} Y币
			</view>
			...
			<view
				...
				<view v-else-if="info.cancel_type == 2">
					买方已取消订单
				</view>
				<view v-else-if="info.cancel_type == 3">
					卖方已取消订单
				</view>
				<view v-else>
					已取消订单
