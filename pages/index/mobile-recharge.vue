	...
	<view style="width: 100%;">
		<view style="padding: 30rpx;">
			<view v-if="type == 1"
				...
				<view style="padding: 34rpx;">
					...
					<view
						style="height: 80rpx;margin-top: 12rpx;background: #F6F7F9;border-radius: 24rpx;display: flex;align-items: center;width: 100%;">
						<view style="width: 100%;margin-left: 34rpx;">
							<input type="text" placeholder="请输入机主姓名"
								placeholder-style="font-weight: 400;font-size: 30rpx;color: #B7BAC7;width: 100%" />
						</view>
					</view>
				</view>
			...
			<view v-else
				...
				<view v-for="(item, index) in numbers" :key="index" style="font-weight: 400;font-size: 28rpx;color: #757B8C;margin-bottom: 22rpx;">{{item}}</view>
			...
			<view style="margin-top: 26rpx;height: 100rpx;background: #F6F7F9;border-radius: 24rpx;display: flex;justify-content: space-between;
				...
				<view>
					...
					<span v-if="type == 1" style="margin-left: 14rpx;font-weight: bold;font-size: 40rpx;">{{activeMeal.discountedPrice}}</span>
					<span v-if="type == 2" style="margin-left: 14rpx;font-weight: bold;font-size: 40rpx;">{{activeMeal.discountedPrice * numbers.length}}</span>
				</view>
				<view>
			...
			<view style="margin-top: 40rpx;display: flex;justify-content: space-between;">
				...
				<view v-if="type == 1" style="font-weight: bold;font-size: 28rpx;color: #000000;">{{activeMeal.discount}}折
					优惠{{activeMeal.price2}}Y币</view>
				<view v-if="type == 2" style="font-weight: bold;font-size: 28rpx;color: #000000;">{{activeMeal.discount}}折
					优惠{{activeMeal.price2 * numbers.length}}Y币</view>
			</view>
			...
			<view style="margin-top: 36rpx;display: flex;justify-content: space-between;align-items: center;">
				...
				<view v-if="type == 1" style="font-weight: bold;font-size: 36rpx;color: #EB8E26;">{{activeMeal.discountedPrice}} Y币</view>
				<view v-if="type == 2" style="font-weight: bold;font-size: 36rpx;color: #EB8E26;">{{activeMeal.discountedPrice * numbers.length}} Y币</view>
			</view>
			<view style="margin-top: 60rpx;height: 80rpx;background: #3742C5;border-radius: 32rpx;font-weight: bold;font-size: 28rpx;color: #FFFFFF;
					...
					<view style="padding: 34rpx;">
						<view style="padding: 30rpx;background: #F6F7F9;border-radius: 32rpx;">
							<u-textarea v-model="numbers_txt" border="none"
								style="font-weight: 400;font-size: 28rpx;background-color: #F6F7F9;" autoHeight
								height="204rpx" placeholder="请输入..."
						...
						<view style="display: flex;justify-content: center;margin-top: 40rpx;">
							<view @click="daoru" style="width: 260rpx;height: 80rpx;background: #3742C5;border-radius: 18rpx;font-weight: bold;font-size: 28rpx;color: #FFFFFF;text-align: center;
