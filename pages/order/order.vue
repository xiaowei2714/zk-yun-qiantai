	...
	<view style="width: 100%;">
		<view style="padding: 30rpx;padding-bottom: 245rpx;">
			...
			<view style="margin-top: 48rpx;display: flex;flex-wrap: wrap;">
				...
				<view @click="toOrderList('mobile', 1)" style="width: 25%;text-align: center;position: relative;">
					<view style="position: absolute;top: -30rpx;right: 32rpx;width: 40rpx;height: 40rpx;border-radius: 100%;background-color: red;font-weight: bold;
						font-size: 22rpx;color: #FFFFFF;text-align: center;line-height: 40rpx;">
						12
					</view>
					<view>
				...
				<view @click="toOrderList('mobile', 2)" style="width: 25%;text-align: center;">
					<view>
				...
				<view @click="toOrderList('mobile', 3)" style="width: 25%;text-align: center;position: relative;">
					<view style="position: absolute;top: -30rpx;right: 32rpx;width: 40rpx;height: 40rpx;border-radius: 100%;background-color: red;font-weight: bold;
						font-size: 22rpx;color: #FFFFFF;text-align: center;line-height: 40rpx;">
						6
					</view>
			...
			<view style="margin-top: 48rpx;display: flex;flex-wrap: wrap;">
				...
				<view @click="toOrderList('electricity', 1)" style="width: 25%;text-align: center;position: relative;">
					<view style="position: absolute;top: -30rpx;right: 32rpx;width: 40rpx;height: 40rpx;border-radius: 100%;background-color: red;font-weight: bold;
						font-size: 22rpx;color: #FFFFFF;text-align: center;line-height: 40rpx;">
						12
					</view>
				...
				<view @click="toOrderList('electricity', 2)" style="width: 25%;text-align: center;position: relative;">
					<view style="position: absolute;top: -30rpx;right: 32rpx;width: 40rpx;height: 40rpx;border-radius: 100%;background-color: red;font-weight: bold;
						font-size: 22rpx;color: #FFFFFF;text-align: center;line-height: 40rpx;">
						8
					</view>
				...
				<view @click="toOrderList('electricity', 3)" style="width: 25%;text-align: center;">
					<view>
						<image src="/static/order-yiqux.png" style="width: 45rpx;height: 45rpx;" mode=""></image>
					</view>
					<view style="margin-top: 10rpx;font-weight: 400;font-size: 24rpx;color: #9C9EA8;">已取消</view>
			...
			<view style="margin-top: 66rpx;font-weight: bold;font-size: 32rpx;">油卡订单</view>
			<view style="margin-top: 48rpx;display: flex;flex-wrap: wrap;">
				<view @click="toOrderList('oil', 0)" style="width: 25%;text-align: center;">
					<view>
						<image src="/static/order-quanb.png" style="width: 45rpx;height: 45rpx;" mode=""></image>
					</view>
					<view style="margin-top: 10rpx;font-weight: 400;font-size: 24rpx;color: #9C9EA8;">全部</view>
				</view>
				<view @click="toOrderList('oil', 1)" style="width: 25%;text-align: center;">
					<view>
						<image src="/static/order-chongzz.png" style="width: 45rpx;height: 45rpx;" mode=""></image>
					</view>
					<view style="margin-top: 10rpx;font-weight: 400;font-size: 24rpx;color: #9C9EA8;">充值中</view>
				</view>
				<view @click="toOrderList('oil', 2)" style="width: 25%;text-align: center;">
					<view>
						<image src="/static/order-yiwanc.png" style="width: 45rpx;height: 45rpx;" mode=""></image>
					</view>
					<view style="margin-top: 10rpx;font-weight: 400;font-size: 24rpx;color: #9C9EA8;">已完成</view>
				</view>
				<view @click="toOrderList('oil', 3)" style="width: 25%;text-align: center;position: relative;">
					<view style="position: absolute;top: -30rpx;right: 32rpx;width: 40rpx;height: 40rpx;border-radius: 100%;background-color: red;font-weight: bold;
						font-size: 22rpx;color: #FFFFFF;text-align: center;line-height: 40rpx;">
						6
					</view>
