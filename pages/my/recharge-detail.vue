	...
	<view style="width: 100%;">
		...
		<view style="padding: 30rpx;">
			...
			<view style="margin-top: 80rpx;display: flex;justify-content: space-between;">
				...
				<view style="font-weight: 400;font-size: 28rpx;">1361446202409182003</view>
			</view>
			<view style="margin-top: 30rpx;display: flex;justify-content: space-between;">
				...
				<view style="font-weight: 400;font-size: 28rpx;">1000.00 USDT</view>
			</view>
			...
			<view style="margin-top: 150rpx;height: 80rpx;background: #3742C5;border-radius: 32rpx;font-weight: bold;font-size: 28rpx;color: #FFFFFF;text-align: center;
				line-height: 80rpx;">
				充值未到账？
			</view>
